...
local luaInOneVideoSamples = { }

function luaInOneVideoSamples.demo()

  urlReference="http://www.newthinktank.com/2015/06/learn-lua-one-video/"
  io.write(string.format("-- ---------- Learn Lua in One Video  ---------- \n"))
  io.write(string.format("%s \n", urlReference))
  io.write(string.format("-- --------------------------------------------- \n"))
 
  luaInOneVideoSamples.basics()
  luaInOneVideoSamples.math()
  luaInOneVideoSamples.conditionals()
  luaInOneVideoSamples.looping()
  luaInOneVideoSamples.tables()
  luaInOneVideoSamples.functions()
  luaInOneVideoSamples.coroutines()
  luaInOneVideoSamples.fileio()
  luaInOneVideoSamples.modules()
  luaInOneVideoSamples.metatables()
  luaInOneVideoSamples.oop()
  luaInOneVideoSamples.inheritance()

end

function luaInOneVideoSamples.basics()

  io.write(string.format("-- ---------- BASICS ---------- \n"))
...
function luaInOneVideoSamples.math()

  io.write(string.format("-- ---------- MATH ---------- \n"))
...
function luaInOneVideoSamples.conditionals()

  io.write(string.format("-- ---------- CONDITIONALS ---------- \n"))
...
function luaInOneVideoSamples.looping()

  io.write(string.format("-- ---------- LOOPING ---------- \n"))
  ...
  repeat
    io.write("Enter your guess (try 15) : ")
...
function luaInOneVideoSamples.tables()

  io.write(string.format("-- ---------- TABLES --------- \n"))
...
-- This contains samples function declarations
...
-- This Contains Function Calls
function luaInOneVideoSamples.functions()

  io.write(string.format("-- ---------- FUNCTIONS --------- \n"))
...
function luaInOneVideoSamples.coroutines()

  io.write(string.format("-- ---------- COROUTINES --------- \n"))
...
function luaInOneVideoSamples.fileio()

  io.write(string.format("-- ---------- FILE I/O --------- \n"))
...
function luaInOneVideoSamples.modules()

  io.write(string.format("-- ---------- MODULES --------- \n"))
...
function luaInOneVideoSamples.metatables()

  io.write(string.format("-- ---------- METATABLES --------- \n"))
...
function luaInOneVideoSamples.oop()

  io.write(string.format("-- ---------- OBJECT ORIENTED PROGRAMMING --------- \n"))
...
function luaInOneVideoSamples.inheritance()

  io.write(string.format("-- ---------- INHERITANCE --------- \n"))
